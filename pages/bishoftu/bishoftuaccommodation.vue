      ...
      <div class="container">
        <div class="wrapper">
          <ul class="link-destination">
            <li>
               <nuxt-link  class="a-link active" to="bishoftuaccommodation"><p>Bishoftu</p>
                <img
                  class="drop-icon"
            ...
            <li><nuxt-link  class="a-link active" to="bishoftuaccommodation"> <p>Accomodation</p>  </nuxt-link > </li>
